...
SLACK_WEBHOOK=T4LRPDYTE/B4LSP537W/NvNlYWErWrjtcBgYM7RuX27r
...
if strings --help > /dev/null 2>&1 ; then
        ...
        echo "Command 'strings' not found. This package needs to be installed through 'sudo dnf install bintuils' or 'sudo apt install binutils'"
fi
